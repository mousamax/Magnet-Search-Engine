...
public class QueryProcessor{
    ...
    public static void main(String[] args) throws JSONException, IOException, FileNotFoundException, ParseException, org.json.simple.parser.ParseException  {
        ...
        mp = (Map<String, Map<String, Integer>>) obj;
        Map<String, Map<String, Integer>> processedMap = new HashMap<String, Map<String, Integer>>();

        String query = "Computer the car in new york";
        ...
        //loop through mp
        for(Map.Entry<String, Map<String, Integer>> entry : mp.entrySet()){
        ...
        writeToFile(convertToJSON(processedMap).toString(), "./index.json");
    }
    public static JSONObject convertToJSON(Map<String, Map<String, Integer>> mp) throws JSONException {
